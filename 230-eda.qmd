...
author: "Otho Mantegazza _ Dataviz for Scientist _ Part 2.3"
editor_options:  
...
Which step do you have to define explicitely? Which step are defined implicitely by Seaborn?
...
In a heatmap we map a quantitative value to a color. Heatmaps can be used both with categorical x and y axes, or binned continous axes.
