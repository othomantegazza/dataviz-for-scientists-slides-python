...
This graphs overlay two informations: the projected data are shown as a scatterplot, and the loadings are shown as arrows starting from the center.
...
The x axis represents the loci, the position across all chromosomes, which are diplayed by color. The y axis represents the minus log p-value of the association test between the loci and the phenotypic trait which is being studied.
:::
...
If you try to change them you'll encounter opposition, because you'll require your readers to go through a mental burdenn, when they are exposed to a change to the visual model that they are used to process intuitively.
...
They might be an improvements for you, but be miselading to others.
